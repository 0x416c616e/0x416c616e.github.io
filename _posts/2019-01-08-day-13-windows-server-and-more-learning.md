...
I had a lot of projects planned for this #100daysofcode challenge. However, I've only managed to finish a couple projects thus far -- the ESXi hypervisor, this website, my EZcrypt app, and I'm now currently working on a Windows Server project, a LAMP osTicket project, and my main project that I should be spending more time and effort on: a static site generator written in python. But this static site generator is taking me significantly more time than I thought it would, and I'm already 1/8th of the way done with this 100 day period. I might not be able to finish everything in time after all. But maybe the problem isn't the speed at which I work on these projects, but rather the expectations I had about being able to finish so many things before the given deadline.

Not only that, but I keep on coming up with new ideas for projects. For example, I wasn't originally planning on doing a Windows Server project, I only recently came up with that idea because I've been thinking about how Active Directory is really important to know if I ever want to go into IT or a multidisciplinary role rather than a pure software-related posiition. 

Basically, I can come up with ideas for projects faster than I can complete them, so maybe I need to prune my list of projects and narrow it down to just a few concrete things. I'm definitely going to make the static site generator, because it's much easier than some of my other projects. 

Software doesn't exist in a vacuum. You have to consider reality, like time limitations. If you didn't have time as a limiting factor, you could do all sorts of things with coding. But because life is short, and time is money, time management and scheduling need to be considered during development. I've heard people talk about agile and devops and sprints, though I don't know too much about them in-depth. I've done kanban and trello board things before, but despite my relative lack of experience with project management, I'm definitely picking up on the fact that time is hugely important in software. Sometimes it might mean cutting corners or excluding features in a program and only concentrating on the bare essentials, and only adding in extras if time allows for it. Or in my case, I'm not just working on a single project for these 100 days, but the goal is to build up a portfolio of projects. 

One thing I've noticed about some of my recent projects is that I'd rather make something okay and move on to the next instead of polishing something to make it perfect. You can make something 95% of what you want it to be in a relatively short amount of time, but make perfectionist changes to get it to be 100% of what your initial vision was can take many times longer. So sometimes you have to revise your standards about what it's going to be like. 